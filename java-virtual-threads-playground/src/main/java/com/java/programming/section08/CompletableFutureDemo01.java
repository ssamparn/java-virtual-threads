 ...
 *  2. Similar to JavaScript promises, it provides a clean and expressive way to work with async tasks, handle errors and combine results.
 ...
 *  Yes. It provides a nice way to handle errors. Also, it has been out there for like 12 years. Many application still use it. So we should use completable future along with virtual threads.
 *
 ...
 *  8. As part of Java 21, we can use virtual-thread-per-task executor with Completable Future.
 *
 * Limitation of Completable Future:
 *  It implements Future, but cancel() method does NOT interrupt the thread running the task.
 * */
@Slf4j
public class CompletableFutureDemo01 {
     ...
     *  2. Greet user by "RECEIVED " + product.toUpperCase(). In case of any issues or exception, just say, "Never received a product...!"
    ...
    static void main(String[] args) throws ExecutionException, InterruptedException {
        String product = CompletableFuture.supplyAsync(() -> RestClient.getProduct(2))
