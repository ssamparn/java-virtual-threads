package com.explore.javavirtualthreadsstreamgathererapp.config;
...
public class AppConfiguration {
    ...
    @Bean
    public GeoDataClient geoDataClient(RestClient.Builder builder,
                                       @Value("${geo-data-service.url}") String baseUrl) {
